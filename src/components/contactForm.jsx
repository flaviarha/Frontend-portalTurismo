...
const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        const response = await axios.post("https://backend-portalturismo-3rae.onrender.com/api/contacts", {
            name: formData.name,
    ...
    return(
        <>
        <div
            className="min-h-screen bg-cover bg-center flex-col items-center justify-center px-4 py-8"
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <textarea
                    ...
                    onChange={handleChange}
                    required
                    className="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-red-700 text-sm sm:text-base"
