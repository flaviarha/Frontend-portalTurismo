...
const RegisterForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
          const response = await axios.post("https://backend-portalturismo-3rae.onrender.com/api/users" ,{
            name: nome,
            email,
            password:senha
          });
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
                ...
                <div>
                        ...
                        <input
                            ...
                            focus:ring-2 focus:ring-red-800 text-sm sm:text-base text-black"
                    ...
                    <button type="submit" className="bg-red-800 hover:bg-red-700 px-6 py-2
